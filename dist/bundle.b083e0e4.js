...
},{"../internals/shared":"../node_modules/core-js-pure/internals/shared.js","../internals/uid":"../node_modules/core-js-pure/internals/uid.js"}],"../node_modules/core-js-pure/internals/correct-prototype-getter.js":[function(require,module,exports) {
var fails = require('../internals/fails');
...
},{"../internals/an-object":"../node_modules/core-js-pure/internals/an-object.js","../internals/a-possible-prototype":"../node_modules/core-js-pure/internals/a-possible-prototype.js"}],"../node_modules/core-js-pure/internals/to-integer.js":[function(require,module,exports) {
var ceil = Math.ceil;
...
},{"../internals/classof-raw":"../node_modules/core-js-pure/internals/classof-raw.js","../internals/global":"../node_modules/core-js-pure/internals/global.js"}],"../node_modules/core-js-pure/internals/engine-user-agent.js":[function(require,module,exports) {
var getBuiltIn = require('../internals/get-built-in');
...
},{"../internals/engine-is-node":"../node_modules/core-js-pure/internals/engine-is-node.js","../internals/engine-v8-version":"../node_modules/core-js-pure/internals/engine-v8-version.js","../internals/fails":"../node_modules/core-js-pure/internals/fails.js"}],"../node_modules/core-js-pure/internals/use-symbol-as-uid.js":[function(require,module,exports) {
...
},{"../internals/well-known-symbol":"../node_modules/core-js-pure/internals/well-known-symbol.js","../internals/iterators":"../node_modules/core-js-pure/internals/iterators.js"}],"../node_modules/core-js-pure/internals/to-string-tag-support.js":[function(require,module,exports) {
var wellKnownSymbol = require('../internals/well-known-symbol');
...
},{"../internals/global":"../node_modules/core-js-pure/internals/global.js"}],"../node_modules/core-js-pure/internals/redefine.js":[function(require,module,exports) {
var createNonEnumerableProperty = require('../internals/create-non-enumerable-property');
...
},{"../internals/create-non-enumerable-property":"../node_modules/core-js-pure/internals/create-non-enumerable-property.js"}],"../node_modules/core-js-pure/internals/redefine-all.js":[function(require,module,exports) {
...
},{"../internals/redefine":"../node_modules/core-js-pure/internals/redefine.js"}],"../node_modules/core-js-pure/internals/object-to-string.js":[function(require,module,exports) {
'use strict';
var TO_STRING_TAG_SUPPORT = require('../internals/to-string-tag-support');
var classof = require('../internals/classof');
...
},{"../internals/shared-store":"../node_modules/core-js-pure/internals/shared-store.js"}],"../node_modules/core-js-pure/internals/check-correctness-of-iteration.js":[function(require,module,exports) {
var wellKnownSymbol = require('../internals/well-known-symbol');
...
},{}],"../node_modules/core-js-pure/internals/native-weak-map.js":[function(require,module,exports) {
...
},{"../internals/to-integer":"../node_modules/core-js-pure/internals/to-integer.js","../internals/require-object-coercible":"../node_modules/core-js-pure/internals/require-object-coercible.js"}],"../node_modules/core-js-pure/internals/iterators-core.js":[function(require,module,exports) {
'use strict';
var fails = require('../internals/fails');
var getPrototypeOf = require('../internals/object-get-prototype-of');
var createNonEnumerableProperty = require('../internals/create-non-enumerable-property');
...
},{"@babel/runtime-corejs3/core-js/promise":"../node_modules/@babel/runtime-corejs3/core-js/promise.js"}],"../node_modules/core-js-pure/internals/is-array.js":[function(require,module,exports) {
var classof = require('../internals/classof-raw');
...
},{"core-js-pure/stable/instance/concat":"../node_modules/core-js-pure/stable/instance/concat.js"}],"../node_modules/core-js-pure/modules/es.json.stringify.js":[function(require,module,exports) {
var $ = require('../internals/export');
var getBuiltIn = require('../internals/get-built-in');
var fails = require('../internals/fails');
...
},{"core-js-pure/stable/json/stringify":"../node_modules/core-js-pure/stable/json/stringify.js"}],"../node_modules/core-js-pure/modules/es.array.filter.js":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
...
},{"core-js-pure/stable/instance/filter":"../node_modules/core-js-pure/stable/instance/filter.js"}],"../node_modules/core-js-pure/modules/web.timers.js":[function(require,module,exports) {
...
},{"core-js-pure/stable/set-timeout":"../node_modules/core-js-pure/stable/set-timeout.js"}],"../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
},{"regenerator-runtime":"../node_modules/regenerator-runtime/runtime.js"}],"assets/images/trash.svg":[function(require,module,exports) {
module.exports = "/trash.44e8d927.svg";
},{}],"scripts/bundle.js":[function(require,module,exports) {
"use strict";
...
var btn = document.getElementById("btn-short");
var inputField = document.getElementById("inputField");
var warning = document.querySelector(".warning");
var container = document.getElementsByClassName("container__result")[0];
var urlRegex = /(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi;
var hamburger = document.querySelector(".hamburger");
var hamburger__container = document.querySelector(".hamburger__container");
var hamburger__toggle = true; //3. RETURN URL

var getShortURL = /*#__PURE__*/function () {
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://api.shrtco.de/v2/shorten?url=".concat(url));
  ...
  return function getShortURL(_x) {
...
var truncate = function truncate(str) {
  var length = 30;
  var ending = "...";
  var truncatedStr = str.substring(0, length - ending.length) + ending;
  var result = str.length > length ? truncatedStr : str;
  return result;
}; //4. DISPLAY DATA
...
var displayData = function displayData() {
  container.innerHTML = "";
  var result = JSON.parse(localStorage.getItem("URLDB"));

  var trash = require("../assets/images/trash.svg");

  if (result != null) {
    (0, _forEach.default)(result).call(result, function (element) {
      var _context2, _context3, _context4;

      var div = document.createElement("div");
      div.classList.add("container__result-each");
      div.setAttribute("id", element.code);
      var html = (0, _concat.default)(_context2 = (0, _concat.default)(_context3 = (0, _concat.default)(_context4 = "\n      <div class=\"original\">\n        <p class=\"original__url\">".concat(truncate(element.original_link), "</p>\n      </div>\n      <div class=\"short\">\n        <p class=\"short__url\">")).call(_context4, element.full_short_link, "</p>\n        <button aria-label=\"Copy\" data-clipboard-text=")).call(_context3, element.full_short_link, " class=\"btn-secondary copy\">Copy</button>\n        <button aria-label=\"Delete\" id=\"delete\"><img  alt=\"Delete\" src=")).call(_context2, trash, "></button>\n      </div>\n      ");
      div.innerHTML = html;
...
btn.addEventListener("click", function () {
  ...
  if (urlValue.match(urlRegex)) {
    ...
    btn.disabled = true;
    getShortURL(urlValue).then(function (data) {
      data.ok ? urlArray.push(data.result) : alert(data.error);
    }).then(function () {
      // STORE in LS
      localStorage.setItem("URLDB", (0, _stringify.default)(urlArray));
    }).then(function () {
      btn.disabled = false;
      container.innerHTML = "";
...
document.addEventListener("click", function (e) {
  if (e.target.parentNode.id === "delete") {
    var result = JSON.parse(localStorage.getItem("URLDB"));
    var code = e.target.parentNode.parentNode.parentNode.id;
    console.log(code);
    var urlArr = (0, _filter.default)(result).call(result, function (element) {
      if (element.code !== code) {
        return element;
      }
    });
    localStorage.setItem("URLDB", (0, _stringify.default)(urlArr));
    displayData();
  }
}); // 6. COPY
...
},{"@babel/runtime-corejs3/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs3/helpers/asyncToGenerator.js","@babel/runtime-corejs3/core-js-stable/instance/for-each":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/for-each.js","@babel/runtime-corejs3/core-js-stable/instance/concat":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/concat.js","@babel/runtime-corejs3/core-js-stable/json/stringify":"../node_modules/@babel/runtime-corejs3/core-js-stable/json/stringify.js","@babel/runtime-corejs3/core-js-stable/instance/filter":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/filter.js","@babel/runtime-corejs3/core-js-stable/set-timeout":"../node_modules/@babel/runtime-corejs3/core-js-stable/set-timeout.js","@babel/runtime-corejs3/regenerator":"../node_modules/@babel/runtime-corejs3/regenerator/index.js","../assets/images/trash.svg":"assets/images/trash.svg"}],"C:/Users/Suraj pc/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/Suraj pc/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/bundle.js"], null)
//# sourceMappingURL=/bundle.b083e0e4.js.map